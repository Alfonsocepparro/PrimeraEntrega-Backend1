...
router.get('/', async (req, res)=>{ //muestra los productos
    try {
...
router.get('/:pid', async (req, res) => { //muestra uno solo
    try {
...
router.post('/', async (req, res) =>{ //crea en el json
    try {
        const { body } = req
...
router.put('/:pid', async (req, res) => { //edita un product
    try {
...
router.delete('/:pid', async (req, res) => { //borra uno
    try {
